...
OSCL_EXPORT_REF const char *Oscl_FileFind::FindFirst(const char *directory, const char *pattern,
...
OSCL_EXPORT_REF const oscl_wchar *Oscl_FileFind::FindFirst(const oscl_wchar *directory,
                                                           const oscl_wchar *pattern,
                                                           oscl_wchar *buf, uint32 buflen) {
    ...
    if ((0 ==
         oscl_UnicodeToUTF8(directory, oscl_strlen(directory), convdir, oscl_strlen(directory) + 1)
         && oscl_strlen(directory))
        || (0 ==
            oscl_UnicodeToUTF8(pattern, oscl_strlen(pattern), convpattern, oscl_strlen(pattern) + 1)
            && oscl_strlen(pattern))) {
